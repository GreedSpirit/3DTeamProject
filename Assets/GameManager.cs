...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField] private InteractSpawn _interactSpawn;
    ...
    public IEnumerator AchivePanelCoroutine(string comment)
    {
        _achivePanel.SetActive(true);
        _achivePanel.GetComponentInChildren<TextMeshProUGUI>().text = comment;
        yield return new WaitForSeconds(2f);
        _achivePanel.SetActive(false);
    }
}